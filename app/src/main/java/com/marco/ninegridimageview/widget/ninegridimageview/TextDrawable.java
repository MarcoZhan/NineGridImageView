 ...
 * @Author Marco
 * @Date 2019/10/7 0007
 * @Des 可以自定义背景颜色和文字的 Drawable，支持圆形和矩形，支持边距。
 */
public class TextDrawable extends ShapeDrawable {
    ...
    private TextDrawable(Builder builder) {
        ...
        fontRatio = builder.fontRatio;
        xRatio = builder.xRatio;
        yRatio = builder.yRatio;
    ...
    public void draw(Canvas canvas) {
        ...
        int fontSize = this.fontSize < 0 ? (Math.min(width, height) / this.fontRatio) : this.fontSize;
    ...
    public static class Builder implements IConfigBuilder, IShapeBuilder, IBuilder {
        ...
        public IConfigBuilder fontRatio(int fontRatio) {
            this.fontRatio = fontRatio;
            return this;
        }

        @Override public IConfigBuilder xRatio(float xRatio) {
            this.xRatio = xRatio;
            return this;
        }

        @Override public IConfigBuilder yRatio(float yRatio) {
            this.yRatio = yRatio;
            return this;
        }
    ...
    public interface IConfigBuilder {
        ...
        /**
         * 设置字体大小，字体大小=Math.min(width, height)/fontRatio，如果设置了 fontSize 将优先 fontSize
         *
         * @param ratio
         * @return
         */
        IConfigBuilder fontRatio(int ratio);

        /**
         * 文字 x 轴位置，x = width * xRatio，xRatio 默认等于 0.5
         *
         * @param xRatio
         * @return
         */
        IConfigBuilder xRatio(float xRatio);

        /**
         * 文字 y 轴位置，y = height * yRatio，yRatio 默认等于 0.5
         *
         * @param yRatio
         * @return
         */
        IConfigBuilder yRatio(float yRatio);
